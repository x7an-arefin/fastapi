...
import { pre } from './get-user.pre.js';
import { process } from './get-user.process.js';
import { post } from './get-user.post.js';
...
describe('User — GET lifecycle unit tests', () => {
...
describe('User — GET controller integration tests', () => {
   ...
   */
  it('GET /users/:id responds with expected status', async () => {
